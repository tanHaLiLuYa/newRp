...
raw_data = open(r".\CSSEGISandData\timeseries0422.json")
...
# pieces_list =[{"min":100000,"label": "高数值"},{"min":50000,"max":100000,"label": "zhon数值"},{"min":10000,"max":50000},{min:5000,"max":10000},{min:1000,"max":5000},{min:500,"max":1000},{min:100,"max":500},{"max":100},]
pieces_list=[
...
timeLine.render('全球疫情现存确诊动态地图.html')
