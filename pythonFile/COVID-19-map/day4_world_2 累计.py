...
fileName = "timeseries%s.json"%dateIn


raw_data = open(os.path.join(r".\CSSEGISandData",fileName))
...
nameMap ={"US":"United States","Korea, South":"Korea","Central African Republic":"Central African Rep.",\
    "Congo (Kinshasa)":"Dem. Rep. Congo","Congo (Brazzaville)":"Congo","Burma":"Myanmar","Dominican Republic":"Dominican Rep",\
        "Cote d'Ivoire":"Côte d'Ivoire","Laos":"Lao PDR","Dominican Rep":"Dominican Rep.","Czechia":"Czech Rep.",\
            "Bosnia and Herzegovina":"Bosnia and Herz.","North Macedonia":"Macedonia","Western Sahara":"W. Sahara"}
...
if existData:
    titleIn = "CBIC：全球各国现存确诊_至2020%s"%dateIn
    fileNameOut = "全球疫情现存确诊动态地图.html"
    df1['现存确诊']=""
    ...
    titleIn = "CBIC：全球各国累计确诊_至2020%s"%dateIn
    fileNameOut = "全球疫情累计确诊动态地图.html"
